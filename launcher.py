            ...
            if prog == 'quit':
                ...
                try:
                    ...
                    if choice == 'id':
                        ...
                        search = str(input('Введите "Название заметки" для поиска (Например: Python):'))
                        search_notice(temp_list, search, 2)
                    elif choice == 'msg':
                        search = str(input('Введите "Текст заметки" для поиска (Например: Сегодня семинар):'))
                        search_notice(temp_list, search, 3)
                    elif choice == 'data':
                        search = str(input('Введите "Дату" для поиска (Например: 06-02-2023 18:23:59):'))
